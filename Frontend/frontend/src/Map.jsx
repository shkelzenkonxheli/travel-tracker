...
export default function TravelMap() {
  ...
  const viewBox =
    CONTINENT_VIEWBOX[selectedContinent] || CONTINENT_VIEWBOX.world;
      ...
      <div className="mx-auto w-full max-w-[1320px] px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <header className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-600">
            ...
            <span className="rounded-full bg-white/80 px-3 py-1 shadow-sm">
              Wishlist:{" "}
              <span className="text-slate-900">{wishlist.length}</span>
            </span>
            <span className="rounded-full bg-white/80 px-3 py-1 shadow-sm">
              View:{" "}
              <span className="text-slate-900">{selectedContinentLabel}</span>
            </span>
          </div>
        </header>
